...
fn multiple_proofs_are_sorted_deduplicated_and_conjunctive() {
    ...
    fs::write(
        tmp.path().join("telos/bindings.tel"),
        "proves \"tests/billing.rs::scn_0091_b\" -> SCN-0091\n\
         proves \"tests/billing.rs::scn_0091_a\" -> SCN-0091\n\
         proves \"tests/billing.rs::scn_0091_a\" -> SCN-0091\n",
    )
    .unwrap();
    ...
    assert_eq!(
        ...
        json!({
            ...
            "green": false,
            "tests": [
                {"test":"tests/billing.rs::scn_0091_a","green":true,
                 "command":"git hash-object .green-scn_0091_a"},
                {"test":"tests/billing.rs::scn_0091_b","green":false,
